...
| **Noten** | Tabelle aller Studierenden; Filter nach Status und **Note** (Mehrfachauswahl 1,0–5,0 / ohne Note, Alle wählen/abwählen); Overrides, Kommentare, Szenario-Charts |

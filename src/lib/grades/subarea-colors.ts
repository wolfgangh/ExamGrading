...
export type SubAreaColorClasses = {
  ...
  /** Border */
  border: string;
  /** Tabellen-Zelle (ohne starken Border) */
  cell: string;
  /** Tabellen-Header */
  header: string;
};
...
const PALETTE: SubAreaColorClasses[] = [
  {
    ...
    cell: "bg-sky-50/90 dark:bg-sky-950/35",
    header: "bg-sky-100/95 dark:bg-sky-950/55",
  },
  {
    solid:
    ...
    cell: "bg-violet-50/90 dark:bg-violet-950/35",
    header: "bg-violet-100/95 dark:bg-violet-950/55",
  },
  {
    solid:
    ...
    cell: "bg-teal-50/90 dark:bg-teal-950/35",
    header: "bg-teal-100/95 dark:bg-teal-950/55",
  },
  {
    solid:
    ...
    cell: "bg-orange-50/90 dark:bg-orange-950/35",
    header: "bg-orange-100/95 dark:bg-orange-950/55",
  },
  {
    solid:
    ...
    cell: "bg-rose-50/90 dark:bg-rose-950/35",
    header: "bg-rose-100/95 dark:bg-rose-950/55",
  },
  {
    solid:
    ...
    cell: "bg-lime-50/90 dark:bg-lime-950/35",
    header: "bg-lime-100/95 dark:bg-lime-950/55",
  },
];
